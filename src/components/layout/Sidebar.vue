<template>
  ...
  >
    ...
    <div class="h-14 flex items-center px-3 border-b border-border shrink-0 hover:bg-black/5 dark:hover:bg-white/5 transition-colors cursor-pointer">
      <div class="w-8 h-8 rounded-md bg-brand-100 text-brand-600 flex items-center justify-center font-bold shrink-0">
...
import { LayoutDashboard, Library, User, ChevronLeft, ChevronRight, CheckSquare } from 'lucide-vue-next'
